...
TEST_MODULES = ("test_bouts", "test_rad", "test_geometry", "test_segment",
                ...
                "test_csi_fst_import", "test_csi_clb", "test_csi_set_write",
                "test_ci_workflows",
                "test_desktop_boundary", "test_progress_runjson",
                "test_experiment_contract",
                "test_queue_contract",
                "test_calibration_contract", "test_acq_check",
                "test_badge_view", "test_results_model",
                "test_packaging_contract",
                "test_report_model",
                "test_export",
                "test_timer_tool_contract",
                "test_input_identity_manifest",
                "test_dp133_generator_behavior",
