; *** DEPRESSION-PLEX 打包：简体中文语言文件（第三方文本） ***
;
; 来源：Inno Setup 官方仓库（jrsoftware/issrc）
; URL: https://raw.githubusercontent.com/jrsoftware/issrc/main/Files/Languages/ChineseSimplified.isl
; 版本：6.5.0+（从 main 分支获取于 2026-09-14）
; 许可：与 Inno Setup 主程序相同（开源，可随 Inno Setup 编译的安装包分发）
; 原因：简体中文不在 Inno Setup 官方安装包中，需随仓分发以支持中文安装向导
;
